...
import com.lion328.thaifixes.MCPXFontStyle;
...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    private ResourceLocation getUnicodePageLocation(int p_111271_1_)
    {
        ...
        {
        	if(p_111271_1_ == 0x0E)
        		unicodePageLocations[p_111271_1_] = ThaiFixesCore.font;
        	else
    ...
    private float renderUnicodeChar(char p_78277_1_, boolean p_78277_2_)
    {
        ...
        {
        	if(ThaiFixesConfiguration.getFontStyle().equals(ThaiFixesConfiguration.FONT_STYLE.DEFAULT)) {
        		if(ThaiFixesUtils.isSpecialThaiChar(p_78277_1_)) this.posX -= 4;
        	} else if(ThaiFixesConfiguration.getFontStyle().equals(ThaiFixesConfiguration.FONT_STYLE.MCPX)) {
        		if(ThaiFixesUtils.isThaiChar(p_78277_1_))
        			return MCPXFontStyle.instance.render(renderEngine, posX, posY, p_78277_1_, p_78277_2_);
        	}
    ...
    {
    	if(ThaiFixesUtils.isSpecialThaiChar(p_78263_1_)) return 0;
    	if(ThaiFixesConfiguration.getFontStyle().equals(ThaiFixesConfiguration.FONT_STYLE.MCPX))
    		return MCPXFontStyle.instance.getCharWidth(p_78263_1_);
